 ...
 *
 * Here rather than beside the settings shape because it is a view, and every
 * other view in this plugin lives under ./ui. What it edits is defined in
 * ../settings; this module only draws it.
 */
